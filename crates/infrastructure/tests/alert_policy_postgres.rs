...
async fn test_pool() -> PgPool {
    ...
    sqlx::query(
        "TRUNCATE report_extractions, alert_description_generations, attachments, webhook_replay_events, delivery_events, delivery_attempts, deliveries, alert_events, alert_fields, \
